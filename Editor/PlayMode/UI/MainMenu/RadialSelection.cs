...
namespace VRGreyboxing
{
    ...
    public class RadialSelection : MonoBehaviour
    {
        ...
        [HideInInspector] public int currentSelectedPart = -1;
        ...
        /**
         * Display menu items in a circle
         */
        public void SpawnRadialParts(List<Sprite> optionImages, List<string> optionNames, GameObject usedController)
        {
            ...
            for (int i = 0; i < _numberOfParts; i++)
            {
                ...
                Vector3 partVector =
                    Quaternion.AngleAxis(angle - 360 / _numberOfParts / 2 + angleSpacing / 2, transform.forward) *
                    transform.up;
                GameObject optionIcon = Instantiate(optionIconPrefab, radialPart.transform);
                optionIcon.transform.position = transform.position +
                                                new Vector3(0, 0, -1) * mainMenuCanvas.localScale.x +
